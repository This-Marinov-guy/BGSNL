...
groningen : [
  {
    ...
    description: "Celebrate Baba Marta and the National Day",
    bgImage: "24",
    date: "7th March",
    time: "22:00",
    ...
    extraInputs: false,
    text: [
      `Welcome again to our beloved Bulgarian Party Experience`,
      `Come to Sunny Beach and celebrate like a beast. We offer you to occasions - Baba Marta and the National Day of Bulgaria.`,
      `We promise a great experience, drinks, dancing with great music, and of course - some nostalgic for home. So do not hesitate - click the button and reserve your spot!!! 
       `,
    ],
