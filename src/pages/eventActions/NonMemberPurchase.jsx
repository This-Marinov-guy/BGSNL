                    ...
                    <Form id="form" encType="multipart/form-data"
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-12 col-md-12 col-12 mt--20" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                          ...
                          <InputNumber placeholder="1 by default" value={values.quantity} onValueChange={(e) => values.quantity = e.target.value} showButtons buttonLayout="horizontal" style={{ width: '150px' }}
